...
class Reflect {
    ...
    */
    ...
    protected static Method resolveJavaMethod(
        ...
        Method method = null;
        if (bcm == null) Interpreter.debug("resolveJavaMethod UNOPTIMIZED lookup");
        ...
        if (method == null) {
            ...
            try {
                ...
                throw new UtilTargetError(
                        "Security Exception while searching methods of: " + clas, e);
            }
    ...
    */
    ...
    public static Object getObjectProperty(Object obj, String propName)
        ...
        if (method == null)
            throw new ReflectError(
                    "Error in property getter: " + e1 + (e2 != null ? " : " + e2 : ""));
