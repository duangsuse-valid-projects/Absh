...
public class Type {
    ...
    /**
     * A buffer containing the descriptor of this Java type. This field is only used for reference
     * types.
     */
    private char[] buf;

    /**
     * The offset of the descriptor of this Java type in {@link #buf buf}. This field is only used
     * for reference types.
     */
    private int off;
    ...
    /**
     * Returns the name of the class corresponding to this object type. This method should only be
    ...
    /**
     * Returns the internal name of the class corresponding to this object type. The internal name
     * of a class is its fully qualified name, where '.' are replaced by '/'. * This method should
     * only be used for an object type.
     *
     ...
     * qualified name, where '.' are replaced by '/'.
     *
