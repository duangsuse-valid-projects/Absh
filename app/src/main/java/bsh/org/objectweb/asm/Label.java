...
public class Label {
    ...
    /**
     * The stack size at the beginning of this basic block. This size is initially unknown. It is
     * computed by the control flow analysis algorithm (see {@link CodeWriter#visitMaxs visitMaxs}).
     */
    int beginStackSize;

    /**
     * The (relative) maximum stack size corresponding to this basic block. This size is relative to
     * the stack size at the beginning of the basic block, i.e., the true maximum stack size is
     * equal to {@link #beginStackSize beginStackSize} + {@link #maxStackSize maxStackSize}.
     */
    int maxStackSize;
    ...
    /**
     * <tt>true</tt> if this basic block has been pushed in the basic block stack. See {@link
     ...
     *     instead of 2). This is done in {@link CodeWriter#resizeInstructions}.
