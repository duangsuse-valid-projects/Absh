...
/**
 * A visitor to visit the bytecode instructions of a Java method. The methods of this visitor must
 * be called in the sequential order of the bytecode instructions of the visited code. The {@link
 * #visitMaxs visitMaxs} method must be called after all the instructions have been visited. The
 * {@link #visitTryCatchBlock visitTryCatchBlock}, {@link #visitLocalVariable visitLocalVariable}
 * and {@link #visitLineNumber visitLineNumber} methods may be called in any order, at any time
 * (provided the labels passed as arguments have already been visited with {@link #visitLabel
 * visitLabel}).
 */
public interface CodeVisitor {
     ...
     *     <p>IALOAD, LALOAD, FALOAD, DALOAD, AALOAD, BALOAD, CALOAD, SALOAD, IASTORE, LASTORE,
     *     FASTORE, DASTORE, AASTORE, BASTORE, CASTORE, SASTORE,
     *     <p>POP, POP2, DUP, DUP_X1, DUP_X2, DUP2, DUP2_X1, DUP2_X2, SWAP,
     *     <p>IADD, LADD, FADD, DADD, ISUB, LSUB, FSUB, DSUB, IMUL, LMUL, FMUL, DMUL, IDIV, LDIV,
     *     FDIV, DDIV, IREM, LREM, FREM, DREM, INEG, LNEG, FNEG, DNEG, ISHL, LSHL, ISHR, LSHR,
     *     IUSHR, LUSHR, IAND, LAND, IOR, LOR, IXOR, LXOR,
     *     <p>I2L, I2F, I2D, L2I, L2F, L2D, F2I, F2L, F2D, D2I, D2L, D2F, I2B, I2C, I2S,
     *     <p>LCMP, FCMPL, FCMPG, DCMPL, DCMPG,
     *     <p>IRETURN, LRETURN, FRETURN, DRETURN, ARETURN, RETURN,
     *     <p>ARRAYLENGTH,
     *     <p>ATHROW,
     *     <p>MONITORENTER, or MONITOREXIT.
     */
    ...
    /**
     * Visits a type instruction. A type instruction is an instruction that takes a type descriptor
     * as parameter.
     *
     * @param opcode the opcode of the type instruction to be visited. This opcode is either NEW,
     *     ANEWARRAY, CHECKCAST or INSTANCEOF.
     * @param desc the operand of the instruction to be visited. This operand is must be a fully
     *     qualified class name in internal form, or the type descriptor of an array type (see
     *     {@link Type Type}).
     */
     ...
     *     java.lang.Integer Integer}, a {@link java.lang.Float Float}, a {@link java.lang.Long
     *     Long}, a {@link java.lang.Double Double} or a {@link String String}.
     */
